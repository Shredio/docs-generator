...
final readonly class SubmoduleNamespaceDocTemplateMacro implements DocTemplateMacro
{

	public function getName(): string
	{
		return 'submodule-namespace';
	}
	...
	public function invoke(DocTemplateMacroContext $context, array $arguments): string
	{
		...
		return sprintf('`Module\%%ModuleName%%\%s\%%SubmoduleName%%\%s`', $arguments[0], $arguments[1]);
	}
